...
>>>>>>> cdeee6e4f97f06fb949c178e8fffa9bba9d58948
    ...
    case WM_COMMAND:
        ...
        case 0x00A0:
        {
            ...
            hThread = CreateThread(NULL, 0, FileMRUIconThread, (LPVOID)lpit, 0, &dwtid);
        }
        break;
        ...
        return ((hThread != NULL) && (hThread != INVALID_HANDLE_VALUE)) ? TRUE : FALSE;
...
<<<<<<< HEAD
    ...
    StringCchVPrintf(pwchMessage, (SizeOfMem(pwchMessage) / sizeof(WCHAR)), wchFormat, argList);
    va_end(argList);
